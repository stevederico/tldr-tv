...
// blank STRIPE_ENDPOINT_SECRET (this app ships empty Stripe placeholders). Re-assert the
// test value here so the webhook secret guard is deterministic in-process.
